...
insert into [prefix_]links(id,link_cate_id,link_title,link)
  ...
  (2,3,'GitChat','https://gitbook.cn/'),
  (3,3,'Stack Overflow','https://stackoverflow.com/'),
  (4,3,'SegmentFault','https://segmentfault.com/'),
  (5,3,'V2EX','https://www.v2ex.com/'),
  (6,3,'CSDN','https://www.csdn.net/'),
  (7,3,'infoQ','https://www.infoq.cn/'),
  (8,3,'Awesomes','https://www.awesomes.cn/'),
  (9,3,'Google','https://www.google.com.hk/'),
  (10,3,'LeetCode','https://leetcode-cn.com/'),
  (11,3,'牛客网','https://www.nowcoder.com/'),
  (12,3,'码云','https://gitee.com/'),
  (13,3,'Linux公社','https://www.linuxidc.com/'),
  (14,3,'掘金','https://juejin.im/'),
  (15,3,'博客园','https://www.cnblogs.com/'),
  (16,3,'开源中国','https://www.oschina.net/'),
  (17,3,'LearnKu','https://learnku.com/'),
  (18,3,'并发编程网','http://ifeve.com/'),
  (19,3,'Python中文开发者社区','https://www.pythontab.com/'),
  (20,3,'知乎','https://www.zhihu.com/'),
  (21,3,'慕课网','https://www.imooc.com/'),
  (22,3,'网易云课堂','https://study.163.com/'),
  (23,3,'网易公开课','https://open.163.com/'),
  (24,3,'中国大学MOOC','https://www.icourse163.org/'),
  (25,3,'Coursera','https://www.coursera.org/'),
  (26,3,'TED','https://www.ted.com/'),
  (27,3,'阿里云','https://www.aliyun.com/'),
  (28,3,'Dribbble','https://dribbble.com/'),
  (29,3,'Pinterest','https://www.pinterest.com/'),
  (30,3,'花瓣网','https://huaban.com/'),
  (31,3,'LOFTER','http://www.lofter.com/');
