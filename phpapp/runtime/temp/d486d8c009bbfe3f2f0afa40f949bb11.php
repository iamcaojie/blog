          ...
          <ul class="layui-nav layui-nav-tree"  lay-filter="test">
            <li class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                ...
                <dd><a href="javascript:;">轮播设置</a></dd>
                <dd><a href="javascript:;">信息设置</a></dd>
                <dd><a href="javascript:;">主题设置</a></dd>
                <dd><a href="javascript:;">链接设置</a></dd>
            ...
            <li class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd><a id="createblog" href="javascript:;">发布笔记</a></dd>
...
<!--            <div id="web-status-tab" style="display">
            ...
            <div class="layui-input-block">
                ...
                <button class="layui-btn" id="btn1">获取html数据</button>
        ...
        <!--</form>-->
            ...
            <div>文章列表</div>
            <table id="article" class="layui-table" lay-filter="test"></table>
            </div>
            <!-- 留言管理-留言列表 -->`
            <div id="massagelist-tab" style="display">
                <div>留言列表</div>
                <table id="massage-list" class="layui-table" lay-filter="test"></table>
            </div>
            <!-- 留言管理-评论管理 -->
            <div id="commentlist-tab" style="display">
                <div>评论列表</div>
                <table id="comment-list" class="layui-table" lay-filter="test"></table>
            </div>
