<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\server\nginx\html/phpapp/application/blog\view\blog\blog.html";i:1551963884;s:66:"D:\server\nginx\html\phpapp\application\blog\view\public\base.html";i:1551878973;}*/ ?>
...
<![endif]-->
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                  <?php if(is_array($cates) || $cates instanceof \think\Collection || $cates instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($cates) ? array_slice($cates,1,3, true) : $cates->slice(1,3, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;if($cate["blog_category"] !== "无"): ?>
              ...
              <form class="navbar-form navbar-left" action="search" method="get">
                <div class="form-group">
                  <input type="text" id="search_text" name="q" class="search-form" placeholder="请输入搜索内容">
                </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="https://github.com/iamcaojie" target="_blank">Github</a></li>
                    <li><a href="https://leetcode-cn.com/" target="_blank">LeetCode</a></li>
                    <li><a href="https://dribbble.com/" target="_blank">dribbble</a></li>
                    <li><a href="/api">Api</a></li>
                    <li role="separator" class="divider"></li>
                    <li><a href="/tools/index/online">在线工具</a></li>
                    <li><a href="/tools/index/download">下载</a></li>
                    <li><a href="/tools/index/doc">文档链接</a></li>
                    <li><a href="/tools/index/web">实用网站</a></li>
                  </ul>
                </li>
              </ul>
            </div><!-- /.navbar-collapse -->
        ...
        <!-- <div class="container-fluid"> -->
            <footer>
                <div id="foot"></div>
                <span id="copyright">COPYRIGHT 2019 CAOJIE. ALL RIGHTS RESERVED.</span><br>
