<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\server\nginx\html/phpapp/application/blog\view\blog\blog.html";i:1557242412;s:66:"D:\server\nginx\html\phpapp\application\blog\view\public\base.html";i:1556963927;}*/ ?>
            ...
            <div class="col-md-4">
                <div id="about-me" class="channel-box">
                    ...
                    <ul id="contact" style="text-align: center;">
                        ...
                        <li>
                            <a href="http://wpa.qq.com/msgrd?v=3&uin=1041973277&site=qq&menu=yes" target="_blank" title="QQ-1041973277">
                                <i class="fa fa-qq"></i>
                            </a>
                        </li>
                        <li>
                            ...
                            <div><img src="/static/img/wechat.png" style="display:none;"/></div>
                        </li>
                    </ul>
                    ...
                    <div>
                        <ul id="tag">
                            <?php if(is_array($tagData) || $tagData instanceof \think\Collection || $tagData instanceof \think\Paginator): $i = 0; $__LIST__ = $tagData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?>
                                <li><a href="/search?category=tag&q=<?php echo $tag; ?>"><?php echo $tag; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
                </div>
