<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\server\nginx\html/phpapp/application/login\view\login\login.html";i:1552049883;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
    <head>
        <title>登录页面</title>
    ...
    <body>
        <div id="login-box">
            <form id="loginform" action="" method="post">
                ...
                <div id="user">
                    ...
                    <div id="vcode-box" style="display:none;">
                        ...
                        <input type="text" name="vcode" autocomplete="off"/>
                        <p>
            ...
            <div class="back">
                <a href="http://<?php echo $webdata['domain']; ?>">返回首页</a>
